...
Los scripts de creación de tablas y datos de prueba están en:
```
documentacion/scripts-base-datos.sql
```

Para restaurar la base de datos:

```bash
mysql -u root -p reservia < documentacion/scripts-base-datos.sql
```
...
│   └── package.json
├── documentacion/       # Manuales y diagramas UML
...
La documentación incluye los siguientes diagramas:

- **01-casos-de-uso.uxf** - Flujos de usuarios por rol
- **02-diagrama-de-clases.uxf** - Estructura de datos
- **03-diagrama-de-actividades-reserva.uxf** - Proceso de reserva
- **04-diagrama-de-componentes.uxf** - Arquitectura de componentes
- **05-diagrama-de-despliegue.uxf** - Infraestructura
- **07-diagrama-entidad-relacion.uxf** - Modelo ER de BD

Todos los diagramas están en formato UML y pueden visualizarse con [draw.io](https://draw.io) o [Lucidchart](https://lucidchart.com).

## Documentación Adicional

- **manual-tecnico.txt** - Guía técnica detallada del sistema
- **manual-usuario.txt** - Guía para usuarios finales
- **plan-migracion-datos.txt** - Estrategia de migración
- **plan-mantenimiento-soporte.txt** - Plan de mantenimiento
- **despliegue-y-entorno.txt** - Guía de despliegue en producción

## Autoras

- Anyi Paola Gómez Arias
- [Segunda autora si aplica]
...
Para reportes de bugs o sugerencias, por favor abre un [issue](https://github.com/tu-usuario/RESERVIA/issues) en el repositorio.

Para preguntas técnicas contacta a los desarrolladores.
